function DesertCase({ go }) {
  ...
  const posts = [
    ["assets/desert/post_who_cares.webp", "Who Cares? \u2014 desertification awareness campaign post"],
    ["assets/desert/post_dying.webp", "The Land is Dying \u2014 desertification campaign post"],
    ["assets/desert/post_spain_2050.webp", "Spain 2050 \u2014 loss-framing campaign post"],
    ["assets/desert/post_save_land.webp", "Save the Land \u2014 campaign call-to-action post"],
    ["assets/desert/post_friend.webp", "Friend \u2014 social sharing campaign post"],
    ["assets/desert/post_festival.webp", "Into the Desert Benefit Festival \u2014 event announcement post"],
    ["assets/desert/post_video.webp", "Campaign video \u2014 desertification awareness"],
    ["assets/desert/post_viper_cactus.webp", "Viper \xD7 Cactus Edition \u2014 brand collaboration post"]
  ];
  return /* @__PURE__ */ React.createElement("article", { "data-screen-label": "Case: Desertification" }, /* @__PURE__ */ React.createElement("div", { className: "brick-hero" }, /* @__PURE__ */ React.createElement("div", { className: "brick-hero-left" }, /* @__PURE__ */ React.createElement("div", { className: "brick-eyebrow" }, "02 \xB7 Content Strategy & Campaign Design"), /* @__PURE__ */ React.createElement("h1", { className: "brick-title brick-title-logo" }, /* @__PURE__ */ React.createElement("span", { className: "visually-hidden" }, "Into the Desert \u2014 Content Strategy & Campaign Design for a Desertification Awareness Project"), /* @__PURE__ */ React.createElement("img", { src: "assets/desert/title_logo.webp", alt: "", width: 1040, height: 349, draggable: "false" })), /* @__PURE__ */ React.createElement("p", { className: "brick-subtitle" }, "A theory-driven awareness campaign for Commonland \xD7 Viper \u2014 turning a slow climate crisis into a benefit festival Dutch 18\u201334s would actually attend."), /* @__PURE__ */ React.createElement("div", { className: "brick-tags" }, "Content Strategy  \xB7  Campaign Design  \xB7  Visual Communication"), /* @__PURE__ */ React.createElement("div", { className: "brick-meta" }, [
  ...
  ))), /* @__PURE__ */ React.createElement("div", { className: "brick-hero-right" }, /* @__PURE__ */ React.createElement("img", { className: "brick-hero-img", src: "assets/desert/viper_cactus_hero.webp", alt: "Viper \xD7 Into the Desert \u2014 Cactus Edition", width: 1080, height: 1080, draggable: "false", style: { objectPosition: "top center", padding: 0 } }))), /* @__PURE__ */ React.createElement("div", { className: "brick-strip" }, [
    ["10", "Weeks, end-to-end"],
    ...
    ([src, altText], i) => /* @__PURE__ */ React.createElement("figure", { className: "brick-screen-fig", key: i }, /* @__PURE__ */ React.createElement(
      "div",
      {
...
function VRCase({ go }) {
  ...
  const stimuli = [
    ["assets/vr/aisle_unhealthy.webp", "Unhealthy aisle", "Snacks, sugary cereals, confectionery.", 1002, 766],
    ["assets/vr/aisle_neutral.webp", "Neutral aisle", "Milk, bread, breakfast staples.", 1112, 783],
    ["assets/vr/aisle_healthy.webp", "Healthy aisle", "Fresh produce, organic. The target aisle for the manipulation.", 1121, 787]
  ];
  const conditions = [
    ["assets/vr/cond_a.webp", "Condition A \xB7 Experimental", "Healthy section populated with 5\u20137 static NPC avatars. Unhealthy section empty. Avatars positioned to function as a social-proof cue at the shelf edge.", 1123, 797],
    ["assets/vr/cond_b.webp", "Condition B \xB7 Control", "Supermarket empty except for one NPC walking across non-target aisles. Auditory and environmental factors held constant across both conditions.", 1123, 797]
  ];
  const results = [
  ...
  return /* @__PURE__ */ React.createElement("article", { "data-screen-label": "Case: VR Supermarket" }, /* @__PURE__ */ React.createElement("div", { className: "brick-hero" }, /* @__PURE__ */ React.createElement("div", { className: "brick-hero-left" }, /* @__PURE__ */ React.createElement("div", { className: "brick-eyebrow" }, "03 \xB7 VR Research & Behavioural Science"), /* @__PURE__ */ React.createElement("h1", { className: "brick-title brick-title-red", "aria-label": "VR Supermarket \u2014 Behavioural Science Research in Virtual Reality" }, "VR", /* @__PURE__ */ React.createElement("br", null), "Supermarket"), /* @__PURE__ */ React.createElement("p", { className: "brick-subtitle" }, "A between-subjects VR experiment (N = 50) testing whether virtual crowd presence in healthy aisles nudges food selection \u2014 and what a null result says about social realism in immersive retail."), /* @__PURE__ */ React.createElement("div", { className: "brick-tags" }, "VR Research  \xB7  Behavioural Science  \xB7  Statistical Analysis"), /* @__PURE__ */ React.createElement("div", { className: "brick-meta" }, [
    ...
    ([k, v]) => /* @__PURE__ */ React.createElement("div", { className: "brick-meta-row", key: k }, /* @__PURE__ */ React.createElement("span", { className: "brick-meta-key" }, k), /* @__PURE__ */ React.createElement("span", { className: "brick-meta-val" }, v))
  ))), /* @__PURE__ */ React.createElement("div", { className: "brick-hero-right" }, /* @__PURE__ */ React.createElement("img", { className: "brick-hero-img", src: "assets/vr/store_cutaway.webp", alt: "3D cutaway of the VR supermarket environment", width: 1122, height: 795, draggable: "false", style: { objectPosition: "top center", padding: 0 } }))), /* @__PURE__ */ React.createElement("div", { className: "brick-strip" }, [
    ["50", "Participants"],
    ["2", "Conditions"],
  ...
  )), /* @__PURE__ */ React.createElement("h4", { className: "brick-sublabel brick-sublabel-spaced" }, "Research framework"), /* @__PURE__ */ React.createElement("div", { className: "vr-framework" }, /* @__PURE__ */ React.createElement("img", { src: "assets/vr/framework.webp", alt: "Research framework: Social Density \u2192 Healthy Choices, moderated by SSI", width: 951, height: 286, draggable: "false" })))), /* @__PURE__ */ React.createElement("section", { className: "brick-section", id: "vr-method" }, /* @__PURE__ */ React.createElement("h2", { className: "brick-label" }, "Method", /* @__PURE__ */ React.createElement("img", { className: "brick-label-asset vr-method-photo", src: "assets/vr/lab_session.webp", alt: "Participant wearing a Meta Quest headset during a VR session at the BMS Lab", width: 396, height: 606, draggable: "false" })), /* @__PURE__ */ React.createElement("div", { className: "brick-body", style: { paddingTop: 48 } }, /* @__PURE__ */ React.createElement("p", { className: "brick-lead-sm", style: { fontSize: "30px" } }, "A 3D supermarket in Unity. Meta Quest. 50 participants. Two conditions."), /* @__PURE__ */ React.createElement("p", null, "Participants entered a customised supermarket in Unity via Meta Quest headsets at the University of Twente's BMS Lab. After a teleportation-movement habituation phase, they were instructed to ", /* @__PURE__ */ React.createElement("b", null, "\u201Ccollect five breakfast items.\u201D"), " All movement was logged via Unity positional tracking. Post-task, participants completed a Qualtrics questionnaire covering the SSI scale, the manipulation check, and demographic controls."))), /* @__PURE__ */ React.createElement("section", { className: "brick-section", style: { paddingTop: 0, paddingBottom: 16 } }, /* @__PURE__ */ React.createElement("h2", { className: "brick-label" }), /* @__PURE__ */ React.createElement("div", { className: "brick-body" }, /* @__PURE__ */ React.createElement("h4", { className: "brick-sublabel", style: { marginTop: 0 } }, "The environment"), /* @__PURE__ */ React.createElement("p", null, "Three aisles \u2014 unhealthy, neutral, healthy \u2014 with identical shelf space and product counts. Only the social cue varied."))), /* @__PURE__ */ React.createElement("div", { className: "vr-stimuli-grid" }, stimuli.map(
    ([src, name, body, w, h], i) => /* @__PURE__ */ React.createElement("figure", { className: "vr-stimulus", key: src }, /* @__PURE__ */ React.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ React.createElement("img", { src, alt: name, width: w, height: h, draggable: "false" })
...
function KNSContribSlideshow({ images }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "kns-slideshow" }, images.map(
    ([src, w, h], idx) => /* @__PURE__ */ React.createElement(
      "img",
      {
        key: src,
        src,
...
function KNSCase({ go }) {
  ...
  const contribSlides = [
    ["assets/kns/contrib_offline_1.webp", 2048, 1536],
    ["assets/kns/contrib_voicechat.webp", 764, 1249],
    ["assets/kns/contrib_instagram.webp", 946, 2048],
    ["assets/kns/contrib_offline_2.webp", 2048, 1536],
    ["assets/kns/contrib_planning.webp", 946, 2048]
  ];
  const posts = [
    ["assets/kns/post_event_3.webp", 1400, 1400],
    ["assets/kns/post_event.webp", 1440, 1440],
    ["assets/kns/post_event_2.webp", 1080, 1080],
    ["assets/kns/post_launch.webp", 1600, 1600],
    ["assets/kns/post_ramen_collab.webp", 2048, 2048],
    ["assets/kns/post_launch_2.webp", 1440, 1440]
  ];
  return /* @__PURE__ */ React.createElement("article", { "data-screen-label": "Case: Katana" }, /* @__PURE__ */ React.createElement("div", { className: "brick-hero" }, /* @__PURE__ */ React.createElement("div", { className: "brick-hero-left" }, /* @__PURE__ */ React.createElement("div", { className: "brick-eyebrow" }, "04 \xB7 Community Strategy & NFT Utility"), /* @__PURE__ */ React.createElement("h1", { className: "brick-title brick-title-red", "aria-label": "Katana N' Samurai \u2014 Visual Design, Branding & Community Management" }, "Katana N'", /* @__PURE__ */ React.createElement("br", null), "Samurai"), /* @__PURE__ */ React.createElement("p", { className: "brick-subtitle" }, "A six-month rescue mission for a 2,000-piece ukiyo-e NFT \u2014 turning the collectible into a key to Taipei's Japanese-food scene."), /* @__PURE__ */ React.createElement("div", { className: "brick-tags" }, "User Research  \xB7  Community Strategy  \xB7  KOL Partnerships"), /* @__PURE__ */ React.createElement("div", { className: "brick-meta" }, [
    ...
    ([src, w, h], i) => /* @__PURE__ */ React.createElement("figure", { className: "brick-screen-fig", key: i }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("img", { src, alt: "Campaign post " + (i + 1), width: w, height: h, draggable: "false" })
    ))
