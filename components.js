...
function Nav({
  ...
  React.useEffect(() => {
    ...
    if (!footer) return;
    const io = new IntersectionObserver(entries => setHidden(entries[0].isIntersecting), {
  ...
  if (view === "home") {
    ...
    }, "ME"), /*#__PURE__*/React.createElement("a", {
      href: "mailto:" + CONTACT
    }, "CONTACT"));
  }
  if (view === "about") {
  ...
  return /*#__PURE__*/React.createElement("nav", {
    ...
    className: "nav-home" + (hidden ? " hidden" : ""),
    onClick: () => go("home"),
    style: {
      cursor: "pointer"
    }
    ...
    className: "proj-index mono"
  }, String(idx).padStart(2, "0"), " / 04"));
}
...
function OutroCTA() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: "outro-cta" + (atBottom ? " is-in" : ""),
    ref: ref,
    "aria-label": "Get in touch"
  }, /*#__PURE__*/React.createElement("div", {
    className: "outro-group"
  }, /*#__PURE__*/React.createElement("span", {
    className: "outro-interested"
  }, "Interested?"), /*#__PURE__*/React.createElement("a", {
    className: "outro-talk",
    href: "mailto:" + CONTACT
    ...
    style: atBottom ? {
      ...
      transition: "transform 4s linear 0.5s"
    } : {
  ...
  new MutationObserver(muts => {
    for (const m of muts) {
      for (const n of m.addedNodes) {
        ...
        if (n.tagName === "IMG") tag(n);else sweep(n);
      }
    }
