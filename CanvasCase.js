...
function CanvasProcessSlideshow({ slides }) {
  ...
  React.useEffect(() => {
    ...
    const id = setInterval(() => setI((k) => (k + 1) % n), 4e3);
    return () => clearInterval(id);
  }, [n, paused]);
  const jump = (k) => setI((k + n) % n);
  return /* @__PURE__ */ React.createElement("div", { className: "cv-process", onMouseEnter: () => setPaused(true), onMouseLeave: () => setPaused(false) }, /* @__PURE__ */ React.createElement("div", { className: "cv-process-stage" }, slides.map(
    (s, idx) => /* @__PURE__ */ React.createElement(
      "img",
      {
        key: s.src,
        src: s.src,
  ...
  ), /* @__PURE__ */ React.createElement("button", { className: "cv-process-arrow cv-process-prev", "aria-label": "Previous slide", onClick: () => jump(i - 1) }, "\u2039"), /* @__PURE__ */ React.createElement("button", { className: "cv-process-arrow cv-process-next", "aria-label": "Next slide", onClick: () => jump(i + 1) }, "\u203A")), /* @__PURE__ */ React.createElement("div", { className: "cv-process-foot" }, /* @__PURE__ */ React.createElement("p", { className: "cv-caption cv-process-cap" }, slides[i].cap), /* @__PURE__ */ React.createElement("div", { className: "cv-process-dots" }, slides.map(
    (s, idx) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: s.src,
        className: "cv-process-dot" + (idx === i ? " is-active" : ""),
...
function CanvasCase({ go }) {
  ...
  const personas = [
    {
      ...
      avatar: "assets/canvas/persona-sanne.webp",
      aw: 1500,
      ah: 1500,
    ...
    },
    {
      ...
      avatar: "assets/canvas/persona-daan.webp",
      aw: 1500,
      ah: 1500,
    ...
    },
    {
      ...
      avatar: "assets/canvas/persona-mei.webp",
      aw: 1500,
      ah: 1500,
  ...
  const ideation = [
    [
      ...
      "assets/canvas/ideation-raw.webp",
      2200,
      1857
    ],
    [
      ...
      "assets/canvas/ideation-categorize.webp",
      2200,
      1857
    ],
    [
      ...
      "",
      "assets/canvas/ideation-reject.webp",
      2200,
      1857
    ],
    [
      ...
      "assets/canvas/ideation-final.webp",
      2200,
      1159
    ]
  ];
  ...
  const processSlides = [
    { src: "assets/canvas/process-1-sketch.webp", w: 1809, h: 900, cap: "01 \u2014 Paper sketches: status logic and where the pill belongs in the row.", alt: "Hand-drawn notebook sketches of the calendar tab and to-do list with status colour notes." },
    { src: "assets/canvas/process-2-wireframe.webp", w: 1568, h: 900, cap: "02 \u2014 Low-fidelity wireframes: calendar, to-do and assignment screens.", alt: "Greyscale low-fidelity wireframes of three mobile screens." },
    { src: "assets/canvas/process-3-states.webp", w: 1280, h: 980, cap: "03 \u2014 State system: four states defined as reusable pills across both tabs.", alt: "Mid-fidelity state design showing Submitted, Submit, Overdue and NA pills on the calendar and to-do tabs." },
    { src: "assets/canvas/process-4-components.webp", w: 1090, h: 500, cap: "04 \u2014 Component library in Figma: pills, nav, due-time and task-name tokens.", alt: "Figma component library with pill, nav, due-time and task-name components." },
    { src: "assets/canvas/process-5-prototype.webp", w: 687, h: 960, cap: "05 \u2014 High-fidelity prototype: the four states wired into a connected flow.", alt: "High-fidelity prototype screens connected with flow arrows across all four states." }
  ];
  const measures = [
  ...
  return /* @__PURE__ */ React.createElement("article", { "data-screen-label": "Case: Canvas" }, /* @__PURE__ */ React.createElement("div", { className: "brick-hero" }, /* @__PURE__ */ React.createElement("div", { className: "brick-hero-left" }, /* @__PURE__ */ React.createElement("div", { className: "brick-eyebrow" }, "UX Research \xB7 UI Design \xB7 Mobile Redesign"), /* @__PURE__ */ React.createElement("h1", { className: "cv-title" }, "Canvas", /* @__PURE__ */ React.createElement("span", { className: "visually-hidden" }, " LMS \u2014 UX Research & UI Redesign with Usability Testing")), /* @__PURE__ */ React.createElement("p", { className: "brick-subtitle" }, "A self-initiated 4-week case study redesigning Canvas mobile's list views to show submission state \u2014 bringing an existing Canvas web pattern across to the surface where students need it most."), /* @__PURE__ */ React.createElement("p", { className: "cv-hero-note" }, "The fix already existed \u2014 on Canvas web. This project is about closing the gap, not inventing new ground."), /* @__PURE__ */ React.createElement("div", { className: "cv-meta" }, meta.map(
    ...
    ([num, title, sub, file, phdesc, cap, img, iw, ih]) => /* @__PURE__ */ React.createElement(React.Fragment, { key: num }, /* @__PURE__ */ React.createElement("div", { className: "cv-step" }, /* @__PURE__ */ React.createElement("div", { className: "cv-step-label" }, /* @__PURE__ */ React.createElement("b", null, "Step ", num), " \xB7 ", title, " \u2014 ", sub), /* @__PURE__ */ React.createElement("img", { className: "cv-img", src: img, alt: title + " \u2014 " + sub, width: iw, height: ih, draggable: "false" }), cap && /* @__PURE__ */ React.createElement("p", { className: "cv-step-cap" }, cap)), num === "03" && /* @__PURE__ */ React.createElement("div", { className: "cv-cutblock" }, /* @__PURE__ */ React.createElement("p", { className: "brick-lead", style: { fontSize: "30px", marginBottom: 12 } }, "What was cut, and why."), /* @__PURE__ */ React.createElement("p", { style: { fontSize: "17px", lineHeight: 1.65, color: "rgba(0,0,0,0.78)" } }, "Earlier drafts of this project sprawled. Each pivot removed scope that was diluting the central argument. The case study reads as small because the work was disciplined to stay small."), /* @__PURE__ */ React.createElement("div", { className: "cv-table" }, /* @__PURE__ */ React.createElement("div", { className: "cv-table-row cv-table-2" }, /* @__PURE__ */ React.createElement("span", { className: "cv-table-head" }, "Cut"), /* @__PURE__ */ React.createElement("span", { className: "cv-table-head" }, "Why")), cuts.map(
