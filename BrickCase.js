function BrickCase({ go }) {
  ...
  const screens = [
    ["assets/brick/page_01.webp", "01", "Splash", "First-run brand entry.", 585, 1266],
    ["assets/brick/page_02.webp", "02", "Onboarding", "Sign in \u2014 no commitments upfront.", 585, 1266],
    ["assets/brick/page_03.webp", "03", "Lobby", "Friends as bricks in a shared social space.", 585, 1266],
    ["assets/brick/page_04.webp", "04", "Profile", "Streak, rank, achievements \u2014 and the relocated App Block.", 585, 1266],
    ["assets/brick/page_05.webp", "05", "Shop", "Avatar cosmetics + real-world coupons.", 585, 1266],
    ["assets/brick/rank.webp", "06", "Rank", "Leaderboard \u2014 least screen time wins the week.", 390, 844],
    ["assets/brick/page_07.webp", "07", "Settings", "Notifications, themes, privacy.", 585, 1266],
    ["assets/brick/page_08.webp", "08", "App Block selection", "Choose categories of distracting apps to lock.", 585, 1266]
  ];
  const categories = [
  ...
  return /* @__PURE__ */ React.createElement("article", { "data-screen-label": "Case: Brick" }, /* @__PURE__ */ React.createElement("div", { className: "brick-hero" }, /* @__PURE__ */ React.createElement("div", { className: "brick-hero-left" }, /* @__PURE__ */ React.createElement("div", { className: "brick-eyebrow" }, "01 \xB7 UX Research & Design"), /* @__PURE__ */ React.createElement("h1", { className: "brick-title brick-title-logo" }, /* @__PURE__ */ React.createElement("span", { className: "visually-hidden" }, "Brick \u2014 A Usability Study & Redesign of a Gamified Screen-Time App"), /* @__PURE__ */ React.createElement("img", { src: "assets/brick/brick_logo.webp", alt: "", width: 375, height: 75, draggable: "false" })), /* @__PURE__ */ React.createElement("p", { className: "brick-subtitle" }, "A 10-week usability study and redesign of a gamified screen-time app \u2014 surfacing the hidden primary action and yielding 14 prioritised recommendations."), /* @__PURE__ */ React.createElement("div", { className: "brick-tags" }, "UX Research  \xB7  UI Design  \xB7  Usability Testing"), /* @__PURE__ */ React.createElement("div", { className: "brick-meta" }, [
    ...
    ([src, num, name, body, w, h], i) => /* @__PURE__ */ React.createElement("figure", { className: "brick-screen-fig", key: i }, /* @__PURE__ */ React.createElement(
      "div",
      {
      ...
      /* @__PURE__ */ React.createElement("img", { src, alt: `${name} \u2014 ${body}`, width: w, height: h, draggable: "false" })
