...
function Home({
  ...
  React.useEffect(() => {
    ...
    function tick(now) {
      ...
      if (mode === "move") {
        ...
        if (dir > 0 && x > 1.0) x = -0.16;else if (dir < 0 && x < -0.16) x = 1.0;
        if (now >= modeUntil) {
          mode = "pause";
    ...
    function tick() {
      ...
      for (let i = 0; i < n; i++) {
        ...
        for (let j = 0; j < n; j++) {
          ...
          const dd = ci - cj,
            minGap = (rects[i].width + rects[j].width) / 2 + 1;
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    ref: h1Ref
  }, "Joshua Lee".split("").map((ch, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    className: "char"
    ...
    className: "imessage",
    ref: imessageRef
  }, /*#__PURE__*/React.createElement("li", null, "Hi! I'm Joshua \u2014 a UX researcher and visual designer."), /*#__PURE__*/React.createElement("li", null, "I study Communication Science at the University of Twente."), /*#__PURE__*/React.createElement("li", null, "I design with reason. I execute with craft.")), /*#__PURE__*/React.createElement("div", {
  ...
  }, hovered?.title ?? ""), /*#__PURE__*/React.createElement("div", {
    className: "project-info-tags"
  }, hovered?.tags ?? ""))), /*#__PURE__*/React.createElement("div", {
    className: "hero-grid"
    ...
    className: "hero-proj-num mono"
  }, "(", i + 1, ")"), /*#__PURE__*/React.createElement("span", {
    className: "hero-proj-label",
    "aria-hidden": "true"
  }, /*#__PURE__*/React.createElement("span", {
    className: "hero-proj-label-title"
  }, p.title), /*#__PURE__*/React.createElement("span", {
    className: "hero-proj-label-tags"
  }, p.tags)), /*#__PURE__*/React.createElement("span", {
    className: "visually-hidden"
  }, p.title, " \u2014 ", p.tags)))), /*#__PURE__*/React.createElement("footer", {
    className: "site-footer"
  }, /*#__PURE__*/React.createElement("div", {
    className: "footer-contact"
  }, /*#__PURE__*/React.createElement("span", {
    className: "footer-available"
  }, "Available for internship \u2014 Aug 2026")), /*#__PURE__*/React.createElement("a", {
    className: "small",
    href: "https://www.utwente.nl/en/education/bachelor/programmes/communication-science/",
    target: "_blank",
    rel: "noopener noreferrer"
  }, "BSc Communication Science \xA0\xB7\xA0 University of Twente")));
}
